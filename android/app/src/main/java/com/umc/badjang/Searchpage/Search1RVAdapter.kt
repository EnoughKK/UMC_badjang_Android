...
class Search1RVAdapter(private val context: Context):
    RecyclerView.Adapter<Search1RVAdapter.ScholarshipHolder>() {
    ...
    override fun onBindViewHolder(holder: Search1RVAdapter.ScholarshipHolder, position: Int) {
