...
class Search2RVAdapter(private val context: Context):
    RecyclerView.Adapter<Search2RVAdapter.ScholarshipHolder>() {
...
//        checkScholarshipBookmark()
    ...
    override fun onBindViewHolder(holder: Search2RVAdapter.ScholarshipHolder, position: Int) {
