...
class ScholarRecyeclerViewAdapter(private val context: Context):
    RecyclerView.Adapter<ScholarRecyeclerViewAdapter.ScholarshipHolder>() {
    ...
    var datas = ArrayList<ScholarshipData>()
    ...
    override fun onBindViewHolder(holder:ScholarRecyeclerViewAdapter.ScholarshipHolder, position: Int) {
